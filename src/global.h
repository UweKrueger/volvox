...
// Classes from AST.h - we need forward declarations here for pointers
class PrototypeAST;
class ExprAST;
class FunctionAST;
...
extern llvm::Type* llvm_map_type;
...
extern volvoxc::FullType* map_type;
...
extern void InsertSingleDestructor(FullVar* fv, llvm::Value* val, llvm::Instruction* before);
